...
Probability values mapped heuristically

Work Order Received or Won → treated as conversion

60 days aging → higher risk

Forecast based on weighted open pipeline
...
Historical cohort modeling

Automated PDF board export
